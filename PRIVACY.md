...
Local backup exports do not include API keys or keychain secrets. Importing a backup replaces local metadata and history, but it does not import or delete keychain secrets.
